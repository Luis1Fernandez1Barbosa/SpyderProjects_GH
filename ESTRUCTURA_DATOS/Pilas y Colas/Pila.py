# -*- coding: utf-8 -*-
"""
Created on Mon Mar 21 22:11:29 2022
...
Label(frm,text='PILA DE DATOS').grid(row=0,column=1)
Label(frm, text="Inserte dato en pila: ").grid(row=1, column=0, sticky="e", pady="3")
